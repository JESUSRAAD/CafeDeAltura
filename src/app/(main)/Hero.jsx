  ...
  return (
    ...
    <div className="flex items-center max-w-[1200px] min-h-[390px] gap-6">
      <div className="flex flex-col gap-4">
        <h3 className="text-lg font-semibold leading-6 text-[#2a5b45]">De la planta a tu taza</h3>
      ...
      /> */}
        <Image  src="/img/Hero image.png" width={588} height={390} alt="manoCogiendoGranosDeCafe" />
