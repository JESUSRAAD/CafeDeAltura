...
const HomeCardCoffe = ({ brand, img, price, available }) => {
  ...
  const addToCarShop = () => {
    ...
    setCoffeChoiced(...(prev + selection));
  ...
  return (
    <>
      {available ? (
        <div className="flex flex-col items-center justify-center text-center gap-6 w-[282px] min-h-[391.39px] border rounded-lg border-solid border-[#e3ded7] op hover:bg-[#f7f5f3]">
